                    ...
                    <tbody className="divide-y divide-border bg-card">
                      <tr className="hover:bg-muted/50 transition-colors">
                        <td className="px-6 py-4 text-sm font-medium text-foreground">
                          <a href="https://www.coursera.org/search?query=canada%20immigration" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors inline-flex items-center gap-2">
                            Canada Immigration Essentials
                        ...
                        <td className="px-6 py-4 text-sm text-muted-foreground">
                          Covers visa types, PR pathways, settlement steps
                        </td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition-colors">
                        <td className="px-6 py-4 text-sm font-medium text-foreground">
        ...
        <section className="py-24 md:py-32 bg-card border-y border-border">
          <div className="container max-w-6xl mx-auto px-6 md:px-8">
            ...
            <div className="text-center mb-20 space-y-4">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto font-normal leading-relaxed">
                Explore top free online programs that guide you through immigration, settlement, and integration in Canada
              </p>
            </div>
