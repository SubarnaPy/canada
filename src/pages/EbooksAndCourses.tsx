    ...
    try {
      ...
      const allProducts: Product[] = [
        ...(ebooksData || []).map((ebook, index) => ({
          ...
          coverImage: ebook.cover_image || getDefaultImage('ebook', index),
          type: 'ebook' as const,
        ...
        ...(coursesData || []).map((course, index) => ({
          ...
          thumbnail: course.thumbnail || getDefaultImage('course', index),
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="relative py-32 overflow-hidden border-b border-border">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Premium e-books and interactive courses designed by immigration experts. Learn at your own pace with instant access to everything you need.
            </p>
        ...
        {/* Floating Ca rt Button */}
        <Button
          size="lg"
          onClick={() => setIsCartOpen(true)}
          className="fixed bottom-8 right-8 z-50 rounded-full shadow-2xl bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 shadow-[0_0_40px_hsl(var(--primary)/0.5)] hover:shadow-[0_0_50px_hsl(var(--primary)/0.7)] transition-all"
        >
