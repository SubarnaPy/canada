...
export function CartDrawer() {
  const { items, removeFromCart, isCartOpen, setIsCartOpen, totalAmount } = useCart();
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto py-4 space-y-4">
              {items.map((item) => (
                ...
                >
                  <img
                    src={item.coverImage || item.thumbnail || '/placeholder.svg'}
                    alt={item.title}
